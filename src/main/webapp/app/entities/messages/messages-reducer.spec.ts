...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './messages.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MESSAGES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MESSAGES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MESSAGES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MESSAGES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MESSAGES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MESSAGES actions', async () => {
      const arg = 42666;
