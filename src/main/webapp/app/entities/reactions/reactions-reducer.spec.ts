...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './reactions.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REACTIONS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REACTIONS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REACTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_REACTIONS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_REACTIONS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REACTIONS actions', async () => {
      const arg = 42666;
